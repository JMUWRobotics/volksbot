...
#ifndef SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__TRAITS_HPP_
#define SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__TRAITS_HPP_
...
inline std::string to_yaml(const SickLdmrsObject & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sick_scan_xd::msg::SickLdmrsObject & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sick_scan_xd::msg::SickLdmrsObject & msg)
{
  return sick_scan_xd::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sick_scan_xd::msg::SickLdmrsObject>()
{
  return "sick_scan_xd::msg::SickLdmrsObject";
}

template<>
inline const char * name<sick_scan_xd::msg::SickLdmrsObject>()
{
  return "sick_scan_xd/msg/SickLdmrsObject";
}

template<>
struct has_fixed_size<sick_scan_xd::msg::SickLdmrsObject>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<sick_scan_xd::msg::SickLdmrsObject>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<sick_scan_xd::msg::SickLdmrsObject>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__TRAITS_HPP_
