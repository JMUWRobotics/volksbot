...
#ifndef SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__FUNCTIONS_H_
#define SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__FUNCTIONS_H_
 ...
 * calls
 * sick_scan_xd__msg__RadarObject__init().
...
/**
 * It calls
 * sick_scan_xd__msg__RadarObject__fini()
 ...
 * sick_scan_xd__msg__RadarObject__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * sick_scan_xd__msg__RadarObject__Sequence__fini()
 * on the array,
...
#endif  // SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__FUNCTIONS_H_
