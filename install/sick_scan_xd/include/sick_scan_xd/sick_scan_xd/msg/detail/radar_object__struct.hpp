...
#ifndef SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__STRUCT_HPP_
#define SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sick_scan_xd__msg__RadarObject __attribute__((deprecated))
#else
# define DEPRECATED__sick_scan_xd__msg__RadarObject __declspec(deprecated)
#endif
...
struct RadarObject_
{
  ...
  // pointer types
  using RawPtr =
    sick_scan_xd::msg::RadarObject_<ContainerAllocator> *;
  using ConstRawPtr =
    const sick_scan_xd::msg::RadarObject_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sick_scan_xd::msg::RadarObject_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sick_scan_xd__msg__RadarObject
    std::shared_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sick_scan_xd__msg__RadarObject
    std::shared_ptr<sick_scan_xd::msg::RadarObject_<ContainerAllocator> const>
...
using RadarObject =
  sick_scan_xd::msg::RadarObject_<std::allocator<void>>;
...
#endif  // SICK_SCAN_XD__MSG__DETAIL__RADAR_OBJECT__STRUCT_HPP_
