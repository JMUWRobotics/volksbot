...
#ifndef SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__TRAITS_HPP_
#define SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__TRAITS_HPP_
...
inline std::string to_yaml(const SickImu & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const sick_scan_xd::msg::SickImu & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sick_scan_xd::msg::SickImu & msg)
{
  return sick_scan_xd::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sick_scan_xd::msg::SickImu>()
{
  return "sick_scan_xd::msg::SickImu";
}

template<>
inline const char * name<sick_scan_xd::msg::SickImu>()
{
  return "sick_scan_xd/msg/SickImu";
}

template<>
struct has_fixed_size<sick_scan_xd::msg::SickImu>
  : std::integral_constant<bool, has_fixed_size<sensor_msgs::msg::Imu>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sick_scan_xd::msg::SickImu>
  : std::integral_constant<bool, has_bounded_size<sensor_msgs::msg::Imu>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sick_scan_xd::msg::SickImu>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__TRAITS_HPP_
