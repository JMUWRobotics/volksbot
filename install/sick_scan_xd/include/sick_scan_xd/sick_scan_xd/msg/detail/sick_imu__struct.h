...
#ifndef SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__STRUCT_H_
#define SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__STRUCT_H_
...
/// Struct defined in msg/SickImu in the package sick_scan_xd.
/**
  ...
  * Header header  # ROS1
 */
typedef struct sick_scan_xd__msg__SickImu
{
  /// ROS2
...
// Struct for a sequence of sick_scan_xd__msg__SickImu.
typedef struct sick_scan_xd__msg__SickImu__Sequence
{
...
#endif  // SICK_SCAN_XD__MSG__DETAIL__SICK_IMU__STRUCT_H_
