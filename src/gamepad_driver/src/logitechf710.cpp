    ...
    switch ( event.type ) {
        ...
        case EV_TYPE_AXIS:
        {
            ...
            switch ( event.code ) {
                ...
                case LOGI_AXIS_THROTTLE_LEFT   : jss.throttle.left  = (axis_t) ( val / (float)MAX_THROTTLE_VALUE * AXIS_VALUE_MAX ); break;
                case LOGI_AXIS_THROTTLE_RIGHT  : jss.throttle.right = (axis_t) ( val / (float)MAX_THROTTLE_VALUE * AXIS_VALUE_MAX ); break;
