    ...
    switch ( event.type ) {
        ...
        case EV_TYPE_AXIS:
        {
            ...
            switch ( event.code ) {
                ...
                case LOGI_AXIS_THROTTLE_LEFT   : ev.code = gp_index::LT; ev.value.axis = (axis_t) ( val / (float)LOGI_MAX_THROTTLE_VALUE * AXIS_VALUE_MAX ); break;
                case LOGI_AXIS_THROTTLE_RIGHT  : ev.code = gp_index::RT; ev.value.axis = (axis_t) ( val / (float)LOGI_MAX_THROTTLE_VALUE * AXIS_VALUE_MAX ); break;
