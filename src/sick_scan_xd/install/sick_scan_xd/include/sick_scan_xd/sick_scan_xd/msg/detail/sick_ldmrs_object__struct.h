...
#ifndef SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__STRUCT_H_
#define SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__STRUCT_H_
...
/// Struct defined in msg/SickLdmrsObject in the package sick_scan_xd.
typedef struct sick_scan_xd__msg__SickLdmrsObject
{
  int32_t id;
  /// ROS1: time tracking_time # since when the object is tracked
...
// Struct for a sequence of sick_scan_xd__msg__SickLdmrsObject.
typedef struct sick_scan_xd__msg__SickLdmrsObject__Sequence
{
...
#endif  // SICK_SCAN_XD__MSG__DETAIL__SICK_LDMRS_OBJECT__STRUCT_H_
