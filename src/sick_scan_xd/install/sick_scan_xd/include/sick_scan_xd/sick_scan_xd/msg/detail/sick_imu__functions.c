...
sick_scan_xd__msg__SickImu__init(sick_scan_xd__msg__SickImu * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sick_scan_xd__msg__SickImu__fini(msg);
    return false;
  }
  // imu
...
sick_scan_xd__msg__SickImu__create()
{
  ...
  sick_scan_xd__msg__SickImu * msg = (sick_scan_xd__msg__SickImu *)allocator.allocate(sizeof(sick_scan_xd__msg__SickImu), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sick_scan_xd__msg__SickImu));
  bool success = sick_scan_xd__msg__SickImu__init(msg);
  if (!success) {
...
sick_scan_xd__msg__SickImu__Sequence__init(sick_scan_xd__msg__SickImu__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sick_scan_xd__msg__SickImu * data = NULL;

  if (size) {
    data = (sick_scan_xd__msg__SickImu *)allocator.zero_allocate(size, sizeof(sick_scan_xd__msg__SickImu), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sick_scan_xd__msg__SickImu__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sick_scan_xd__msg__SickImu__fini(&data[i - 1]);
      }
...
sick_scan_xd__msg__SickImu__Sequence__fini(sick_scan_xd__msg__SickImu__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sick_scan_xd__msg__SickImu__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sick_scan_xd__msg__SickImu__Sequence * array = (sick_scan_xd__msg__SickImu__Sequence *)allocator.allocate(sizeof(sick_scan_xd__msg__SickImu__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sick_scan_xd__msg__SickImu__Sequence__init(array, size);
  if (!success) {
...
sick_scan_xd__msg__SickImu__Sequence__destroy(sick_scan_xd__msg__SickImu__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sick_scan_xd__msg__SickImu__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sick_scan_xd__msg__SickImu__Sequence__are_equal(const sick_scan_xd__msg__SickImu__Sequence * lhs, const sick_scan_xd__msg__SickImu__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sick_scan_xd__msg__SickImu__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sick_scan_xd__msg__SickImu__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sick_scan_xd__msg__SickImu);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sick_scan_xd__msg__SickImu * data =
      (sick_scan_xd__msg__SickImu *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sick_scan_xd__msg__SickImu__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sick_scan_xd__msg__SickImu__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sick_scan_xd__msg__SickImu__copy(
